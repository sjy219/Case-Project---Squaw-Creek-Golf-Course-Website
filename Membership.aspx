...
<body>
	...
	<form id="form1" runat="server">
        <div class="article_frame">
            <p class="membership_title_text">Sign up for a membership today!</p>
            <div class="membership_input_frame">
                <!--- MEMEBERSHIP TEXTBOXES and USER PROMPT--->
                <asp:Label ID="lblUserPrompt" runat="server" Text="Please Enter Your Information." CssClass="textbox"></asp:Label>
                ...
                <!--- RADIO BUTTONS --->
                <p class="membership_text">Membership Duration</p>
                <asp:RadioButtonList ID="rblMemDuration" runat="server" RepeatDirection="Horizontal" CssClass="membership_text">
                    <asp:ListItem>Monthly</asp:ListItem>
                    <asp:ListItem>Yearly</asp:ListItem>
                    </asp:RadioButtonList>
                <p class="membership_text"> Membership Type</p>
                <asp:RadioButtonList ID="rblMemType" runat="server" RepeatDirection="Horizontal" CssClass="membership_text">
                    <asp:ListItem>Single</asp:ListItem>
                    <asp:ListItem>Couple</asp:ListItem>
                    <asp:ListItem>Senior</asp:ListItem>
                    <asp:ListItem>Senior Couple</asp:ListItem>
                </asp:RadioButtonList>
                <br />
                <asp:Button ID="btnSubmitMem" runat="server" Text="Submit" OnClick="btnSubmitMem_Click" />
                <asp:Button ID="btnClearMem" runat="server" Text="Clear" OnClick="btnClearMem_Click" /> 
                <br />  
                <br />  
            </div>      
        </div>
...
<footer> 
		<p <="copyright"><strong>@ 2017 Squaw Creek Golf Course </strong></p>
